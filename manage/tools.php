...
$disable_unit = 1; $is_manage_tools = 1;
?>
<!doctype html>
...
<head>
    ...
    <title><?php echo TITLE ?> - MANAGE TOOLS</title>
                  ...
                  <table id="tools_list" class="datatables-users table">
                    ...
                    <tbody>
                      ...
                      while ($row = mysqli_fetch_assoc($query)) {
                          ...
                          echo "<tr>";
                          echo "<td>" . $no . "</td>";
                          echo "<td id='tool_name_" . $row['no'] . "'>" . $row['peralatan'] . "</td>";
                          echo "<td>
                            <div class='dropdown'>
                              ...
                              <div class='dropdown-menu'>
                                <a class='dropdown-item waves-effect edit-tool' href='javascript:;' data-id='" . $row['no'] . "'><i class='ri-pencil-line'></i> Edit</a>
                                <a class='dropdown-item waves-effect delete-tool' href='javascript:;' data-id='" . $row['no'] . "'><i class='ri-delete-bin-7-line me-1'></i>Delete</a>
                              </div>
                            </div>
                          </td>";
                          echo "</tr>";
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="input-group input-group-merge mb-6">
                                            <span id="basic-icon-default-toolsname" class="input-group-text"><i class="ri-tools-line"></i></span>
                                            <div class="form-floating form-floating-outline">
                                                ...
                                                <label for="basic-icon-default-toolsname">Nama Peralatan</label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#tool_form').on('submit', function (e) {
                ...
                $.ajax({
                    url: 'tools/update', // Pastikan URL benar
                    type: 'POST',
                    data: formData,
                    dataType: 'json',
                    success: function(data) {
                        ...
                        if (data.success) {
                            ...
                            window.location.replace("?successMessage=Berhasil memperbarui peralatan");
                        } else {
            ...
            $('#tools_list').on('click', '.delete-tool', function () {
                ...
                if (confirm('Apakah Anda yakin ingin menghapus peralatan ini?')) {
                    $.ajax({
                        url: 'tools/delete', // Pastikan URL benar
                        type: 'POST',
